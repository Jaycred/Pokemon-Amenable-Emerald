...
const u8 gText_DeoxysNormalEnabled[] = _("DEOXYS's normal form is enabled.{PAUSE_UNTIL_PRESS}");   // formerly unused
const u8 gText_DeoxysNormalDisabled[] = _("DEOXYS's normal form is disabled.{PAUSE_UNTIL_PRESS}"); // formerly unused
...
const u8 gText_Uniform[] = _("UNIFORM");
...
const u8 gText_PkmnFainted_FldPsn[] = _("{STR_VAR_1} endured the poison.\p\n");
...
const u8 gText_TypeMatchupsReversed[] = _("Type matchups are reversed on this floor."); // Unused
const u8 gText_SpeedReversed[] = _("Speed is reversed on this floor."); // Unused
const u8 gText_UnstableWeatherAdvisory[] = _("Unstable weather advisory. Watch out for-"); // Unused
const u8 gText_BattleBagDisabled[] = _("The BAG is disabled during battle on this floor."); // Unused
const u8 gText_TrickMasterBreached[] = _("The TRICK MASTER has breached containment."); // Unused
...
const u8 gText_LetsGo[] = _("Let's Go! Wild battles are in safari mode!"); // Unused
const u8 gText_ContestTime[] = _("Contest Time!"); // Unused
...
const u8 gText_HauntedFloor[] = _("This floor is haunted…"); // Unused
const u8 gText_Tremors[] = _("The floor is unstable here!\nWatch out for tremors!"); // Unused
...
const u8 gText_MoveRelearnerPkmnTryingToLearnMove[] = _("Should {STR_VAR_1} delete a move\nto learn {STR_VAR_2}?");
...
const u8 gText_WaterStone[] = _("WATER STONE"); // Unused
const u8 gText_ThunderStone[] = _("THUNDER STONE"); // Unused
const u8 gText_FireStone[] = _("FIRE STONE"); // Unused
const u8 gText_LeafStone[] = _("LEAF STONE"); // Unused
const u8 gText_SunStone[] = _("SUN STONE"); // Unused
const u8 gText_MoonStone[] = _("MOON STONE"); // Unused
const u8 gText_KingsRock[] = _("KING'S ROCK"); // Unused
const u8 gText_MetalCoat[] = _("METAL COAT"); // Unused
