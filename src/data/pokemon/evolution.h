const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_MACHOKE]    = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_MACHAMP},
    ...
    [SPECIES_EXEGGCUTE]  = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                            {EVO_LEVEL, 30, SPECIES_EXEGGUTOR}},
    ...
    [SPECIES_CHANSEY]    = {{EVO_FRIENDSHIP, 0, SPECIES_BLISSEY},
                            {EVO_LEVEL, 30, SPECIES_BLISSEY}},
    [SPECIES_HORSEA]     = {{EVO_LEVEL, 20, SPECIES_SEADRA}},
    [SPECIES_SEADRA]     = {{EVO_ITEM, ITEM_KINGS_ROCK, SPECIES_KINGDRA},
    ...
    [SPECIES_PORYGON]    = {{EVO_ITEM, ITEM_METAL_COAT, SPECIES_PORYGON2},
    ...
    [SPECIES_BAGON]      = {{EVO_LEVEL, 20, SPECIES_SHELGON}},
