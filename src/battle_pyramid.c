...
static const u16 sPickupItemsLvlOpen[100] =
{
    ...
    ITEM_MOOMOO_MILK, ITEM_MOOMOO_MILK, ITEM_MOOMOO_MILK, ITEM_HYPER_POTION, ITEM_HYPER_POTION, ITEM_HYPER_POTION, ITEM_MAX_POTION, ITEM_MAX_POTION, ITEM_FULL_RESTORE, ITEM_FULL_RESTORE,
    ITEM_X_ATTACK, ITEM_X_ATTACK, ITEM_X_ATTACK, ITEM_X_SPECIAL, ITEM_X_SPECIAL, ITEM_X_SPECIAL, ITEM_X_SPEED, ITEM_X_SPEED, ITEM_X_SPEED, ITEM_X_SPEED,
    ITEM_HEART_SCALE, ITEM_HEART_SCALE, ITEM_HEART_SCALE, ITEM_HEART_SCALE, ITEM_HEART_SCALE, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_MAX_ELIXIR, ITEM_MAX_ELIXIR, ITEM_MAX_ELIXIR,
    ITEM_MASTER_BALL, ITEM_MASTER_BALL, ITEM_MASTER_BALL, ITEM_TM_TOXIC, ITEM_TM_TOXIC, ITEM_TM_TOXIC, ITEM_TM_PROTECT, ITEM_TM_PROTECT, ITEM_TM_PROTECT, ITEM_TM_DOUBLE_TEAM,
    ITEM_TM_DOUBLE_TEAM, ITEM_TM_DOUBLE_TEAM, ITEM_TM_PROTECT, ITEM_SHELL_BELL, ITEM_SHELL_BELL, ITEM_SHELL_BELL, ITEM_LEFTOVERS, ITEM_LEFTOVERS, ITEM_SCOPE_LENS, ITEM_SCOPE_LENS,
...
static const struct PyramidTrainerEncounterMusic sTrainerClassEncounterMusic[54] =
{
    ...
    {TRAINER_CLASS_PKMN_RANGER, TRAINER_ENCOUNTER_MUSIC_ROCKET},
...
static void SetPickupItem(void)
{
    ...
    gSpecialVar_0x8000 = sPickupItemsLvlOpen[rand];
...
static void InitPyramidBagItems(u8 lvlMode)
{
    ...
    AddPyramidBagItem(ITEM_SODA_POP, 6);
...
u16 GetBattlePyramidPickupItemId(void)
{
    ...
    return sPickupItemsLvlOpen[rand];
}
