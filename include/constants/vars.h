...
#define VAR_DEOXYS_ROCK_STEP_COUNT                       0x4034 // Re-used for Pyramid weather
#define VAR_DEOXYS_ROCK_LEVEL                            0x4035 // Re-used for Pyramid music
...
#define VAR_PYRAMID_LEVEL_CAP                            0x404E // Unused Var; now stores player's highest level at start of each Pyramid floor
#define VAR_LOTAD_SIZE_RECORD                            0x404F
#define VAR_LITTLEROOT_TOWN_STATE                        0x4050
#define VAR_OLDALE_TOWN_STATE                            0x4051
#define VAR_MYSTERIOSITY_MESSAGE                         0x4052 // (Formerly) Unused Var
