...
static const u8 sText_TryToLearnMove3[] = _("Should {B_BUFF1} delete a move\nto make room for {B_BUFF2}?");
...
static const u8 sText_PkmnHungOnWithX2[] = _("{B_DEF_NAME_WITH_PREFIX} hung on\nusing its {B_LAST_ABILITY}!");
...
const u8 * const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_PKMNHUNGONWITHX2 - BATTLESTRINGS_TABLE_START] = sText_PkmnHungOnWithX2,
};
...
const u16 gWeatherStartsStringIds[] =
{
    ...
    [WEATHER_VOLCANIC_ASH]       = STRINGID_STARTEDHAIL,
