...
static const u16 sPickupItemsLvlOpen[100] =
{
    ...
    ITEM_LUM_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_LEPPA_BERRY, ITEM_LUM_BERRY, ITEM_SALAC_BERRY, ITEM_SALAC_BERRY, ITEM_SALAC_BERRY,
};
