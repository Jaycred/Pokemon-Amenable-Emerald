...
#define FLAG_DID_PHYSICAL_MOVE               0x68 // Used to indicate which stats are affected when moves like Superpower, Psychic, Overheat receive STAB split
...
#define FLAG_UNUSED_RS_LEGENDARY_BATTLE_DONE 0x71 // Used for a first-talk NPC flag.
...
#define FLAG_DEOXYS_NORMAL                                          0x470 // (Formerly) unused Flag
